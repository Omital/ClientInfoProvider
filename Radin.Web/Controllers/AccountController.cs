...
using Radin.Sessions;
using Radin.Web.Controllers.Results;
using Radin.Web.Models;
using Radin.Web.Models.Account;
using System;
...
{
    public class AccountController : RadinControllerBase
    {
        ...
        {
            var ss = ClientInfoProvider.BrowserInfo;
